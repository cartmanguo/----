...
#define FONT_SIZE (IS_4INCH_DEVICE)? 15:13
...
{
    UIImageView *infoView = [[UIImageView alloc] initWithFrame:_contentView.frame];
    infoView.image = [UIImage imageNamed:@"doginfo"];
    [self.contentView addSubview:infoView];
    UIImageView *historyView = [[UIImageView alloc] initWithFrame:CGRectMake(_contentView.frame.size.width, 0, _contentView.frame.size.width, _contentView.frame.size.height)];
    historyView.image = [UIImage imageNamed:@"his"];
    [self.contentView addSubview:historyView];
    UIImageView *personalityView = [[UIImageView alloc] initWithFrame:CGRectMake(_contentView.frame.size.width*2, 0, _contentView.frame.size.width, _contentView.frame.size.height)];
    personalityView.image = [UIImage imageNamed:@"personality"];
    [self.contentView addSubview:personalityView];
}
...
- (void)setupViews
{
    ...
    UIImageView *avatar = [[UIImageView alloc] initWithFrame:CGRectMake(5, 5, 128, 128)];
    avatar.image = [UIImage imageNamed:@"dog1.png"];
    ...
    UIImageView *history = [[UIImageView alloc] initWithFrame:CGRectMake(_contentView.frame.size.width+5, 5, 128, 128)];
    history.image = [UIImage imageNamed:@"dog3.png"];
    ...
    UIImageView *personality = [[UIImageView alloc] initWithFrame:CGRectMake(_contentView.frame.size.width*2+5, 5, 128, 128)];
    personality.image = [UIImage imageNamed:@"eat.png"];
...
- (void)updatePath
{
    ...
    katanaFrame.origin.x -= self.textView.textContainerInset.left+5;
	katanaFrame.origin.y -= self.textView.textContainerInset.top+5;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    self.title = [NSString stringWithFormat:@"金毛犬简介(第%d/%d页)",page+1,3];
}
